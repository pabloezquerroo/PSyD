...
//    uint8 i;
    ...
    lcd_puts(60, 50, BLACK, "Pulse Keypad 0 para jugar");
    lcd_puts(50, 170, BLACK, "Use los pulsadores para mover");
    lcd_puts(50, 190, BLACK, "Keypad 0 para reiniciar");
    lcd_puts(50, 210, BLACK, "Keypad 3 para pausar");
...
void reinicio(){
	...
	sprite_plot( &firemen, 0 );					// Dibuja los bomberos en todas sus posiciones posibles
	firemenPos=0;
